...
for f in plugins/*/skills/*/SKILL.md; do
  ...
  # блок = від маркера до наступного рядка, що починається з ** або ---; sed-діапазон
  # тут не годиться: без закриваючого рядка він тягне файл до кінця, і writer'ом
  # виглядає кожен скіл, що десь згадує журнал
